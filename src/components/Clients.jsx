...
const Clients = () => {
  return (
    ...
    <h2 className='text-center text-[#ededed] mb-5 text-5xl font-semibold'>Recent Clients</h2>
    <p className='text-center text-[#f4f4f4]'>We worked with the Fortune 500 companies in the USA, Africa, UK, Middle East
