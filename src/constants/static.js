 ...
 export  const platformData = [
    { title: 'Web', image: '/asset 15.svg' },
    { title: 'iOS', image: '/asset 16.svg' },
    { title: 'Android', image: '/asset 17.svg' },
    { title: 'Hybrid', image:'/asset 18.svg' },
    { title: 'Wearables', image: '/asset 19.svg'},
    { title: 'TV', image: '/asset 20.svg' }
  ];

  
 export  const featureData = [
  { title: 'Agile approach', image: '/asset 21.svg' },
  { title: 'Deep tech expertise', image: '/asset 22.svg' },
  { title: 'Personal commitment', image: '/asset 23.svg' },
  { title: 'Regular reporting', image:'/asset 24.svg' },
  { title: 'Time tracking', image: '/asset 25.svg'},
  { title: 'Scalability', image: '/asset 26.svg' }
];
...
export const caseStudies = [
  {
    ...
    sub:"Transforming Fintech with AI",
